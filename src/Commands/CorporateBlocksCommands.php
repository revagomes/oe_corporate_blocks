...
namespace Drupal\oe_corporate_blocks\Commands;

use Drupal\oe_corporate_blocks\LocalTranslationsBatcher;
use Drush\Commands\DrushCommands;

/**
 * Drush commands for the OE Multilingual module.
 */
class CorporateBlocksCommands extends DrushCommands {

  /**
   * The local translations import batcher service.
   *
   * @var \Drupal\oe_corporate_blocks\LocalTranslationsBatcher
   */
   ...
   *
   * @param \Drupal\oe_corporate_blocks\LocalTranslationsBatcher $localTranslationsBatcher
   ...
   *   Command options.
   *
   * @command oe-corporate-blocks:import-local-translations
